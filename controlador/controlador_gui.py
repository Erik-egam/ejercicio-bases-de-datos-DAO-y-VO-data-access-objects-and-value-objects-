...
class ControladorGUI:
    ...
    def _setup_handlers(self):
        ...
        def handler_modificacion_trabajador(fila: int, columna: int):
            ...
            self.formulario_actualizar_Trabajador.id_trabajador_update = self.ventana_trabajadores.w['tabla_trabajador'].item(fila,0).text()
            self.formulario_actualizar_Trabajador.w['label_id'].setText(self.formulario_actualizar_Trabajador.id_trabajador_update)
        ...
        def handler_formulario_insertar_trabajador():
            tupla_nuevo_trabajador = (self.formulario_trabajador.w['input_nombre'].text())
        ...
        def handler_llenar_tabla_trabajadores():
            ...
            self.ventana_trabajadores.llenarTabla(listado_trabajadores=listado_trabajadores)
        ...
        def handler_formulario_insertar_arbol():
            tupla_nuevo_arbol = (self.formulario_arbol.w['input_terreno'].text())
        ...
        self.ventana_principal.w['btn_Trabajadores'].clicked.connect(handler_ventana_trabajadores)
        self.ventana_principal.w['btn_Trabajadores'].clicked.connect(handler_llenar_tabla_trabajadores)
        
        self.ventana_principal.w['btn_Arboles'].clicked.connect(handler_ventana_arboles)
        self.ventana_principal.w['btn_Arboles'].clicked.connect(handler_llenar_tabla_arboles)
        
        
                
        # llenar tablas
        self.ventana_trabajadores.w['btn_Listar_trabajadores'].clicked.connect(handler_llenar_tabla_trabajadores)
        
        self.ventana_arboles.w['btn_Listar_arboles'].clicked.connect(handler_llenar_tabla_arboles)
        

        
        # Registrar 
        self.ventana_trabajadores.w['btn_Registrar_trabajador'].clicked.connect(handler_nuevo_trabajador)
        self.formulario_trabajador.w['btn_guardar'].clicked.connect(handler_formulario_insertar_trabajador)
        self.formulario_trabajador.w['btn_guardar'].clicked.connect(handler_llenar_tabla_trabajadores)
        ...
        self.formulario_actualizar_Trabajador.w['btn_guardar'].clicked.connect(handler_llenar_tabla_trabajadores)
